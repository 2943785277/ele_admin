<template>
  <div class="app-container">
    <div class="filter-container">
      <el-button class="filter-item" style="margin-left: 10px;" type="primary" icon="el-icon-edit" @click="handleCreate(-1)">添加产品</el-button>
    </div>
    ...
    <el-table
	  ...
	  <el-table-column label="标题" align="center">
		...
		<el-table-column label="缩略图" width="150px" align="center">
			<template slot-scope="scope">
				<img :src="scope.row.image" width="40px" height="40px"/>
			</template>
		</el-table-column>
  ...
  methods: {
    getList() {
      this.listLoading = true
			let that = this;
			api.goods_index(this.page).then((res)=>{
...
//       })
    ...
    handleModifyStatus(id,index) {
          ...
          type: 'warning'
					...
					api.goods_remove(data).then((res)=>{
