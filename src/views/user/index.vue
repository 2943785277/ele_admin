<template>
  <div class="app-container">
		<div class="filter-container">
			<el-input placeholder="请输入用户名称" v-model="page.keywords" style="width: 200px;" class="filter-item" @keyup.enter.native="handleFilter"/>
    ...
    <el-table
      ...
      <el-table-column label="ID" prop="id" align="center" width="65">
		...
		<el-table-column label="注册时间" width="350px" align="center">
			<template slot-scope="scope">
  ...
  methods: {
    getList() {
      this.listLoading = true
			let that = this;
			api.user_index(this.page).then((res)=>{
    ...
    handleModifyStatus(id,index) {
          ...
          type: 'warning'
					...
					api.news_discuss_remove(data).then((res)=>{
