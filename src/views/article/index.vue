<template>
  <div class="app-container">
    <div class="filter-container">
      <el-button class="filter-item" style="margin-left: 10px;" type="primary" icon="el-icon-edit" @click="handleCreate(-1)">添加文章</el-button>
    </div>
    ...
    <el-table
	  ...
	  <el-table-column label="分类名称" width="200px">
	    <template slot-scope="scope">
	  ...
	  <el-table-column label="文章标题" align="center">
		...
		<el-table-column label="发布时间" width="350px" align="center">
			<template slot-scope="scope">
				<span>{{ scope.row.create_time}}</span>
			</template>
		</el-table-column>
		<el-table-column label="缩略图" width="150px" align="center">
			<template slot-scope="scope">
				<img :src="scope.row.thumb" width="40px" height="40px"/>
			</template>
		</el-table-column>
  ...
  methods: {
    getList() {
      this.listLoading = true
			let that = this;
			api.news_index(this.page).then((res)=>{
